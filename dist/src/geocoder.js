...
exports.RandomLocation = exports.GetAreaInfo = exports.BMapGeocoder = void 0;
const axios_1 = __importDefault(require("axios"));
const config_1 = __importDefault(require("./config"));
const BMapGeocoder = async (ak, lng, lat) => {
    ...
    const bmap = {
        ...
        MJ: function (a, b) {
            if (a && b) {
                let c = b[0] + b[1] * Math.abs(a.lng), e = Math.abs(a.lat) / b[9];
                e =
                    b[2] +
                        b[3] * e +
                        b[4] * e * e +
    ...
    const resp = await axios_1.default.get("https://api.map.baidu.com/", {
        params: {
            qt: "rgc",
            dis_poi: 100,
            poi_num: 10,
...
exports.BMapGeocoder = BMapGeocoder;
const GetAreaInfo = async (lng, lat) => {
    const data = await exports.BMapGeocoder(config_1.default.BMAP_AK, lng, lat);
...
const RandomLocation = (lng, lat, radius) => {
    const [dis, rad] = [
